<x-admin-layout>
    ...
    <div class="mt-2 max-w-6xl mx-auto">
        <div class="flex justify-end m-2 p-2">
            <a href="{{ route("permission.create") }}" class="px-4 py-2 bg-blue-900 text-white rounded">Create Permission</a>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route("permission.edit",$permission->id) }}" class="font-medium text-blue-600">Edit</a>
